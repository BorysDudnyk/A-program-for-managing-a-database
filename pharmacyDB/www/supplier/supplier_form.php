...
<html>
<head>
    <title>Управління базою даних Постачальник</title>
</head>
<link rel="stylesheet" href="supplier_form.css">
<body>
    <h1>Управління таблицею Постачальник</h1>
    ...
    <form action="supplier.php" method="post">
        <label for="id">ID Постачальника:</label><br>
